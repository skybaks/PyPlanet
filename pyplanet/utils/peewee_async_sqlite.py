"""
Sqlite is not officially supported by the peewee_async libary. This is because
sqlite is performed in-process and does not require the same kind of network
I/O that other databases need.

This module is based on the implementation here: https://gist.github.com/xsduan/09fb145da3da3a78f5ca844b155f27aa
"""
import peewee
